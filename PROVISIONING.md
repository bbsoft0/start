...
* Enter domains to secure (for example): `y`
...
```
ln -s /etc/letsencrypt/live/y/fullchain.pem /etc/ssl/blog.crt
ln -s /etc/letsencrypt/live/y/privkey.pem /etc/ssl/blog.key
```
...
```
6 10,22 * * * /opt/certbot/certbot-auto renew --quiet --no-self-upgrade --webroot-path /home/deployer/apps/blog/shared/public/
```
